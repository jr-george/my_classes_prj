...
public class BooksMenu {
    ...
    public static void main(String s[]) {
        ...
        while(true) {
            System.out.println(
                    "Press 1 to view books, 2 to add books, "+
            ...
            if (userAction.equals("1")) {
                ...
                System.out.println("Press 1 if you want to clone a book or 2 if you want to create one");

                String option = scanner.nextLine();

                if (option.equals(("1")))
                {
                    System.out.println("Type book's index to be clone:");
                    bkIdx= scanner.nextShort();
                    //Book myNewBook = books[bkIdx].clone();
